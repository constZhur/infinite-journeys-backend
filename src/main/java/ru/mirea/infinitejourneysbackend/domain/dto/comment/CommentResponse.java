...
public record CommentResponse(
        ...
        @Schema(description = "Идентификатор связанного тура", example = "1")
        Long tourId,
        ...
        @Schema(description = "Время загрузки комментария", example = "2023-05-05T10:10:10.000+00:00")
        OffsetDateTime createdAt,

        @Schema(description = "Время обновления комментария", example = "2024-05-05T10:10:10.000+00:00")
